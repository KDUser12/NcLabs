...
def os_compatibility() -> None:
    ...
    This feature automatically detects the operating system (Windows, macOS/Darwin, or Linux),
    analyzes its version, and then compares it with the minimum recommended version.
    If the operating system or its version does not meet the minimum criteria,
    the program is terminated with a critical error message via the logger.
